...
export default {
  ...
  data() {
    return {
      newMessage: '',
      room: { id: 123, name: 'Other', createdAt: new Date() },
      rooms: [
        { id: 1, name: 'Amazing' },
        { id: 2, name: 'Other' },
      ],
      messages: [
        { id: 1, text: 'First message', author: 'Israel Sanchez', createdAt: new Date() },
        { id: 1, text: 'Second message', author: 'Another Person', createdAt: new Date() },
      ],
    }
  },
  methods: {
